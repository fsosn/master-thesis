...
Pełny obraz charakterystyki czasowej zapewniają dystrybuanty empiryczne przedstawione na wykresach~\ref{fig:ecdf_all_models}.
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{diagramy/ecdf_others_ttft_llama.pdf}
        \caption{Niski narzut -- Llama-3.1-8B-Instruct}
        \label{fig:ecdf_others_llama}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{diagramy/ecdf_guard_ttft_llama.pdf}
        \caption{Wysoki narzut -- Llama-3.1-8B-Instruct}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{diagramy/ecdf_others_ttft.pdf}
        \caption{Niski narzut -- Mistral-7B-Instruct-v0.3}
        \label{fig:ecdf_others_mistral}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{diagramy/ecdf_guard_ttft.pdf}
        \caption{Wysoki narzut -- Mistral-7B-Instruct-v0.3}
        \label{fig:ecdf_guard_mistral}
    \end{subfigure}

    \caption{Porównanie dystrybuant empirycznych dla metryki TTFT w zależności od zastosowanej obrony}
    \label{fig:ecdf_all_models}
\end{figure}
