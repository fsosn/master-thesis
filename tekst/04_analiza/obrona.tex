...
\begin{table}[!ht]
    ...
    \begin{tabular}{l|c|c|c|c}
        \hline
        \multirow{2}{*}{\textbf{Model $+$ metoda obrony}} & \multicolumn{4}{c}{\textbf{ASR [\%]}}                                               \\\cline{2-5}
                                                          & \textbf{Podstawowo}                   & \textbf{DAN} & \textbf{GCG} & \textbf{PAIR} \\\hline
        Llama-3.1-8B-Instruct + Self-Reminder             & 3                                     & 43           & 1            & 32            \\\hline
        Mistral-7B-Instruct-v0.3 + Self-Reminder          & 7                                     & 76           & 17           & 61            \\\hline
    \end{tabular}
    \caption{\label{tab:self_reminder_comparison_tab}Skuteczność metod ataku z zastosowaniem metody obrony Self-Reminder}
\end{table}
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{\label{tab:guard_comparison_tab}Skuteczność metod ataku na modele chronione przez Llama-Guard}
\end{table}
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{\label{tab:act_comparison_tab}Skuteczność metod ataku na modele chronione mechanizmem opartym na sterowaniu aktywacjami}
\end{table}
...
\subsection{Porównanie skuteczności metod obrony}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{l|l|c|c|c|c}
        \hline
        \multirow{2}{*}{\textbf{Model}} & \multirow{2}{*}{\textbf{Metoda obrony}} & \multicolumn{4}{c}{\textbf{ASR [\%] ($\Delta$ASR [p.p.])}}                                                                                                                                                                               \\\cline{3-6}
                                        &                                         & \textbf{Podstawowo}                                        & \textbf{DAN}                                            & \textbf{GCG}                                            & \textbf{PAIR}                                           \\\hline
    ...
    \end{tabular}
    \caption{Skuteczność metod ataku wobec wdrożonych metod obrony wraz ze spadkami ($\downarrow$) lub wzrostami ($\uparrow$) punktów procentowych względem poziomu bazowego.}
...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}
        \begin{groupplot}[
            ...
            % 1. Wykres po lewej: Llama-3.1-8B-Instruct
            \nextgroupplot[
                title={\textbf{Llama-3.1-8B-Instruct}},
                legend style={
                        at={(1.15, 1.15)},
                        anchor=south,
                        legend columns=3,
            ...
            \addplot[fill=ForestGreen, draw=Black] coordinates {
                    (Podstawowo, 1) (DAN, 0) (GCG, 0) (PAIR, 21)
                };
            \addplot[fill=BrickRed, draw=Black] coordinates {
            ...
            \nextgroupplot[
                title={\textbf{Mistral-7B-Instruct-v0.3}}
            ]
            \addplot[fill=Blue, draw=Black] coordinates {
        ...
        \end{groupplot}
    \end{tikzpicture}
    \caption{Porównanie wskaźnika ASR dla badanych metod obrony i ataku}
