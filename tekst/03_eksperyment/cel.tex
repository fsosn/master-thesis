...
Ostatnim wybranym mechanizmem jest filtrowanie zewnętrzne przy użyciu zewnętrznego modelu Llama-Guard~\cite{inan2023llamaguardllmbasedinputoutput} do analizy zapytań wejściowych oraz wyjściowych odpowiedzi.
